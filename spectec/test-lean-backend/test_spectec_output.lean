...
|      local_get (C : context) (x : localidx) (t : valtype) : Instr_ok (C, LOCAL_GET x, mk_functype [] [t]) -> TEMPORARY_PREM -> TEMPORARY_PREM
|      local_set (C : context) (x : localidx) (t : valtype) : Instr_ok (C, LOCAL_SET x, mk_functype [t] []) -> TEMPORARY_PREM -> TEMPORARY_PREM
|      global_get (C : context) (x : globalidx) (t : valtype) : Instr_ok (C, GLOBAL_GET x, mk_functype [] [t]) -> TEMPORARY_PREM -> TEMPORARY_PREM
|      global_set (C : context) (x : globalidx) (t : valtype) : Instr_ok (C, GLOBAL_GET x, mk_functype [t] []) -> TEMPORARY_PREM -> TEMPORARY_PREM
